...
class DemoGUI:
    def __init__(self, master):
        ...
        self.demo_button = Button(master, text="Demo", command=self.demo, width=10, height=5, font=("TkDefaultFont", 15))
        self.demo_button.grid(row=1, column=0)
        #self.demo_button.pack()

        self.read_button = Button(master, text="Read/Detect", command=self.read, width=10, height=5, font=("TkDefaultFont", 15))
